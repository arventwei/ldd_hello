...
struct scull_dev
{
	...
	int quantum;			 /* the current quantum size  一个quantum有多少字节*/
	int qset;				 /* the current array size ,一个qset有多少个quantum*/
...
#if LINUX_VERSION_CODE > KERNEL_VERSION(2, 6, 0) && !defined(init_MUTEX)
